...
app.post("/deleteuser",async(req,res)=>{
    ...
    try{
        //const 
        // =await BingoBord.findOne({username:username})
...
app.post("/depositcheckB",async(req,res)=>{
  ...
  //const data1 = await BingoBord.findOne({ username: username });
    ...
    let coin1=parseInt(`${data1.coin}`);
    console.log("user name is ",data1);
  console.log("coin is",coin1);
  try{
 
      if(data1){
          res.json(depo1)
          console.log("your balance is ",depo1);
           console.log("your coin is ",coin1);
      }
      else{
          res.json("notexist")
      }
...
: 1;
        console.log( check.gameId);
          ...
          console.log("deduction",waletdeuction);
          const coin1=coin;
           console.log("coin",coin);
          const filter = { username:  username };
          const update = {
              $inc: { Wallet: waletdeuction ,coin: coin1}, // Deduct from Wallet
